...
const Hero = () => {
  return (
    <section className="relative min-h-[600px] bg-gradient-hero flex items-center overflow-hidden">
      ...
      <img
        src={heroImage}
        alt="Economic consulting and forensic analysis background"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-primary-foreground">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12 text-center">
              <Link 
                to="/contact" 
                className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-4 hover:bg-primary-foreground/20 transition-colors cursor-pointer group"
              >
